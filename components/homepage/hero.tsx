...
import { useRouter } from "next/navigation";
  ...
  return (
    <div className="relative flex h-screen max-h-[680px] flex-col w-full p-page">
      ...
      <h1 className="relative z-20 bg-gradient-to-b mt-20 from-white via-neutral-200 to-neutral-400 bg-clip-text py-4 text-4xl font-medium text-transparent md:text-6xl tracking-tighter max-w-4xl leading-tight">
